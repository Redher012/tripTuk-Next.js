        ...
        <tr>
          <td style="background-color: #ffffff; padding: 30px;">
            ...
            <div style="background-color: #d4edda; border: 1px solid #c3e6cb; border-radius: 8px; padding: 20px; margin: 20px 0;">
              <h3 style="margin-top: 0; color: #155724; font-size: 18px;">💰 Refund Information</h3>
              <p style="margin: 5px 0; color: #155724; font-size: 16px; font-weight: bold;">
            ...
            <p style="text-align: center; margin: 30px 0;">
              <a href="https://triptuk.com/contact" style="background-color: #6c757d; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; font-weight: bold; font-size: 16px;">
                Contact Support
              </a>
            </p>
          </td>
